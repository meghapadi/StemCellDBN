...
function(targetdata, preddata=NULL, q, n,
  ...
  self.loops=TRUE, k = 15, options=NULL, outputFile='.',imp.target=0, hard.const=hard.const) {
  ...
  ## Initialize system
  initiation = init9(X, Y, nbCPinit, GLOBvar, HYPERvar, options, hard.const)
  print("Initialisation successful.")

  ## Run niter iterations
  print("Starting tvDBN iterations...")
  runiteration = main9(X, Y, initiation, GLOBvar, HYPERvar, imp.target, hard.const)
  print("")
